...
class FlowDataView(QMainWindow):
    ...
    def __init__(self, controller):
        ...
        self.list = ListDataWidget("Test list", ["Nev", "Tema1", "Tema2"], lambda row: None)
        self.list.add_data([{ "Nev": "Tema1", "Tema1": 1, "Tema2": 2 }, { "Nev": "Tema2", "Tema1": 3, "Tema2": 4 }, { "Nev": "Tema3", "Tema1": 5, "Tema2": 6 }])
        main_frame = QFrame()
